...
const profileAvatarCatalog = <ProfileAvatarOption>[
  ...
  ProfileAvatarOption(
    ...
    fallbackEmoji: '🏴‍☠️',
    assetPath: 'assets/images/profile_avatars/pirate_captain.png',
    goldPrice: 100,
  ),
  ProfileAvatarOption(
    key: 'violet_professor',
    label: 'Professeur astral',
    fallbackEmoji: '🧑‍🏫',
    assetPath: 'assets/images/profile_avatars/violet_professor.png',
    goldPrice: 100,
  ),
  ProfileAvatarOption(
    key: 'french_scout',
    label: 'Éclaireuse française',
    fallbackEmoji: '🎖️',
    assetPath: 'assets/images/profile_avatars/french_scout.png',
    goldPrice: 100,
  ),
  ProfileAvatarOption(
    key: 'crystal_sword_guardian',
    label: 'Gardienne du cristal',
    fallbackEmoji: '🗡️',
    assetPath: 'assets/images/profile_avatars/crystal_sword_guardian.png',
    goldPrice: 100,
  ),
  ProfileAvatarOption(
    key: 'meerkat',
